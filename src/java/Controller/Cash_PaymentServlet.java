 ...
 * @author Polash
 */
public class Cash_PaymentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       String payname=request.getParameter("paymentname");
       Float payamount=Float.parseFloat(request.getParameter("payamount"));
      ...
      PreparedStatement  ps=null;
       ...
       try{
           ...
           String query="insert into cashpayment (PAYMENT_NAME, AMOUNT, DATE) values (?,?,CURDATE()) ";
