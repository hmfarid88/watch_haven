...
//            message.addRecipient(Message.RecipientType.TO, new InternetAddress(too));
            message.setSubject("Data Backup From watch_haven");
                        
        MimeBodyPart messageBodyPart = new MimeBodyPart();
        Multipart multipart = new MimeMultipart();
       
        String file = "D:\\Backup\\watch_haven.sql";
        
        String fileName = "watch_haven.sql";
        ...
        message.setContent(multipart);
            ...
            File f=new File("D:\\Backup\\watch_haven.sql");
            f.delete();
