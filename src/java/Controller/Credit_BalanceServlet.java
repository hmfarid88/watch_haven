 ...
 * @author Polash
 */
public class Credit_BalanceServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String creditby=request.getParameter("creditby");
       ...
       PreparedStatement ps=null;
        ...
        try{
            ...
            String query="insert into creditbalance(CREDIT_NAME, AMOUNT, DATE) values(?,?, CURDATE())";
             ps = con.prepareStatement(query);
             ps.setString(1, creditby);
