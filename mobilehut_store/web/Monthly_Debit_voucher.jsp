                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav">
                               ...
                               <li style="margin: 10px 20px">
                                    <div>
                                        <form action="Datewise_Debit_voucher.jsp" method="POST" class="form-inline">
                                            ...
                                            <tbody id="myTable">
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        String query = "select  DEBIT_NAME, AMOUNT, DATE from debitbalance where YEAR(DATE) = YEAR(CURRENT_DATE()) AND MONTH(DATE) = MONTH(CURRENT_DATE()) order by DATE";
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center"><%= rs.getString("DEBIT_NAME")%></td>
