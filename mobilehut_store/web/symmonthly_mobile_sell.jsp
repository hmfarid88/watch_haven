                                             ...
                                             <tbody id="myTable">
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        String query = "select PRODUCT_ID, CUSTOMER_ID, INVOICE_NO, MODEL, COLOR, PRICE, DISCOUNT, DIS_NOTE, VENDOR, SELL_DATE from mobilesell where YEAR(SELL_DATE) = YEAR(CURRENT_DATE()) AND MONTH(SELL_DATE) = MONTH(CURRENT_DATE()) order by SELL_DATE ";
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center"><%= rs.getString("MODEL")%>, <%= rs.getString("COLOR")%>, <%= rs.getString("PRODUCT_ID")%></td>
