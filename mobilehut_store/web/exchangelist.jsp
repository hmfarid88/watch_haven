                    ...
                    <table  border="2" id="mobiletable" class=" table-striped table-responsive" width="100%" >
                        <thead>
                            <tr style="background-color: #030303; color: #ffffff">
                                ...
                                <th style="text-align: center">St Color</th>
                                <th style="text-align: center">Ex Color</th>
                        ...
                        <%
                            ...
                            try {
                               ...
                               String query = "select MODEL, ST_COLOR, EX_COLOR, IMEI, PURCHASE_PRICE, SELL_PRICE, VENDOR, RETAILER, DATE from stock_exchange";
                        ...
                        <tr>
                            ...
                            <td style="text-align: center"><%= rs.getString("ST_COLOR")%></td>
                            <td style="text-align: center"><%= rs.getString("EX_COLOR")%></td>
