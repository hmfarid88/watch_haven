                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        String query = "select PRODUCT_ID, CUSTOMER_ID, INVOICE_NO, BRAND, MODEL, COLOR, COST_PRICE, PRICE, DISCOUNT, VENDOR,"
                                                ...
                                                <tr> <th>Brand</th> <td><%= rs.getString("BRAND")%></td></tr>
...
try { if (rs != null) rs.close(); rs=null; } catch (SQLException ex2) { }
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                                ...
                                                <%
                                                    try {
                                                        con = Ssymphonyy.getConnection();
                                                        String query = "select PRODUCT_ID, CUSTOMER_ID, INVOICE_NO, BRAND, MODEL, COLOR, COST_PRICE, PRICE, VENDOR,"
                                                                + " STOCK_DATE, SELL_DATE  from vendor_sale where PRODUCT_ID='" + imei + "' ";
                                                        ps = con.prepareStatement(query);
                                                        rs = ps.executeQuery();
                                                        while (rs.next()) {
                                                            int cid=rs.getInt("CUSTOMER_ID");
...
try { if (rs != null) rs.close(); rs=null; } catch (SQLException ex2) { }
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                                ...
                                                <%
                                                    try {
                                                        con = Ssymphonyy.getConnection();
                                                        String query = "select  BRAND, MODEL, COLOR, IMEI, PURCHASE_PRICE, SELL_PRICE, VENDOR,"
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                                ...
                                                <%
                                                    try {
                                                        con = Ssymphonyy.getConnection();
                                                        String query = "select  BRAND, MODEL, COLOR, IMEI, COST_PRICE, SELL_PRICE, VENDOR, STOCK_DATE,"
                                                                + " DATE  from faulty where IMEI='" + imei + "' ";
                                                        ps = con.prepareStatement(query);
                                                        rs = ps.executeQuery();
                                                        while (rs.next()) {
                                                %>
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                                ...
                                                <%
                                                    try {
                                                        con = Ssymphonyy.getConnection();
                                                        String query = "select  BRAND, MODEL, COLOR, IMEI, PURCHASE_PRICE, SELL_PRICE, VENDOR, NOTE, STOCK_DATE,"
