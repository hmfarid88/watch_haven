<%-- 
    Document   : symsellview
    Created on : Oct 13, 2017, 11:31:38 PM
    Author     : Polash
--%>
                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav">
                               ...
                               <li style="margin: 12px 20px">
                                    <div>
                                        <form action="Datewise_card_transition.jsp" method="POST" class="form-inline">
                                            ...
                                            <tbody id="myTable">
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        String query = "select  CARD_ACC_NO, CARD_NO, CARD_RECV, DATE from paymentinfo where CARD_RECV>0 and YEAR(DATE) = YEAR(CURRENT_DATE()) AND MONTH(DATE) = MONTH(CURRENT_DATE()) order by DATE ";
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center"><%= rs.getString("CARD_ACC_NO")%></td>
                                                    <td style="text-align: center"><%= rs.getString("CARD_NO")%></td>
                                                    <th style="text-align: center"><%= rs.getFloat("CARD_RECV")%></th>
