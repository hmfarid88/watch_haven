                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav">
                               <li style="margin-left: 20px"><a href="home.jsp"><span class="fa fa-home"></span> Home</a></li>                           
                                <li><a data-toggle="collapse" data-target="#datdiv" href="#">Date-wise-view</a></li>
                                <li style="margin-top: 10px">  <div id="datdiv" class="collapse">
                                        <form action="Datewise_Payment_voucher.jsp" method="POST" class="form-inline">
                                ...
                                <li><a href="vendor_statement.jsp">Vendor-wise-view</a></li>
                                            ...
                                            <tbody id="myTable">
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        String query = "select  PAYMENT_NAME, AMOUNT, DATE from cashpayment where YEAR(DATE) = YEAR(CURRENT_DATE()) AND MONTH(DATE) = MONTH(CURRENT_DATE()) order by DATE ";
