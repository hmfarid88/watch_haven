                    ...
                    <div class="panel-body"> 
                        <div class="row">
                            <div class="col-sm-12">
                                <div id="div_print">
                                    <center>
                                        <h3>Date wise Card Transition</h3>
                                            ...
                                            <tbody id="myTable">
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        String query = "select  CARD_ACC_NO, CARD_NO, CARD_RECV, DATE from paymentinfo where CARD_RECV>0 and DATE between '"+ date1 +"' and '"+ date2 +"' order by DATE ";
