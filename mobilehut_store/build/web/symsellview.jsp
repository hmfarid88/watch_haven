                                    ...
                                    <table border="2" class=" table-striped table-responsive" width="100%" id="actable" >
                                        ...
                                        <tbody>
                                            <%
                                                try {
                                                    con = Ssymphonyy.getConnection();
                                                    String query = "select PRODUCT_NAME, PRODUCT_ID, MODEL, SELL_PRICE, DISCOUNT, DIS_NOTE, VENDOR, INVOICE_NO, CUSTOMER_ID, DATE from accessor_sale where DATE =CURDATE()";
                                                    ps=con.prepareStatement(query);
                                                    rs = ps.executeQuery();
                                                    while (rs.next()) {
                                                   int cid=rs.getInt(9);
