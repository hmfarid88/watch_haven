                        ...
                        <ul class="nav navbar-nav">
                           <li style="margin-left: 20px"><a href="home.jsp"><span class="fa fa-home"></span> Home</a></li>
                            ...
                            <li style="margin: 15px 15px">
                                <div>
                                    <form action="Datewise_Credit_voucher.jsp" method="POST" class="form-inline">
                                        ...
                                        <tbody id="myTable">
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    String query = "select  CREDIT_NAME, AMOUNT, DATE from creditbalance where YEAR(DATE) = YEAR(CURRENT_DATE()) AND MONTH(DATE) = MONTH(CURRENT_DATE()) order by DATE ";
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center"><%= rs.getString("CREDIT_NAME")%></td>
