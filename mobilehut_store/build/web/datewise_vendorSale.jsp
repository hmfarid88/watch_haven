...
<html class="no-js" lang="">
                                        ...
                                        <tbody id="myTable">
                                            <%
                                                ...
                                                try {
                                                    ...
                                                    String query = "select PRODUCT_ID, CUSTOMER_ID, INVOICE_NO, BRAND, MODEL, COLOR, COST_PRICE, SELL_DATE from vendor_sale where SELL_DATE between '" + date1 + "' and '" + date2 + "' order by CUSTOMER_ID, SELL_DATE";
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                     ...
                                     <table border="1" width="30%" >
                                            <tr>
                                                <td style="text-align: center"><h4>Accessories List</h4></td><td><input style="width: 70%; margin-left: 15%" class="form-control input-sm" id="acInput" type="text" placeholder="Search..."> </td>
                                            </tr>
                                        </table><br>
                                    <table border="2" class=" table-striped table-responsive" width="90%" id="actable" >
                                        <thead>
                                            <tr>
                                                <th style="text-align: center">SN</th>
                                                <th style="text-align: center">Invoice</th>
                                        ...
                                        <tbody id="myTables1">
                                            <%
                                                try {
                                                    con = Ssymphonyy.getConnection();
                                                    String query = "select PRODUCT_NAME, PRODUCT_ID, MODEL, COST_PRICE, INVOICE_NO, CUSTOMER_ID, DATE from vendor_accessor_sale where DATE between '" + date1 + "' and '" + date2 + "' order by CUSTOMER_ID, DATE";
                                                    ps = con.prepareStatement(query);
                                                    rs = ps.executeQuery();
                                                    while (rs.next()) {
                                                        int cid=rs.getInt(6);
