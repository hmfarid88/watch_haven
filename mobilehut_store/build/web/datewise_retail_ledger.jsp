    ...
    <br> <center><h3> You are not logged in</h3><br/>
        ...
        <%
            ...
            try {
                ...
                String query = "select BRAND, PRODUCT_ID, MODEL, COLOR, COST_PRICE, SELL_DATE from vendor_sale where RETAILER=? and  SELL_DATE between '"+ date1 +"' and '"+ date2 +"'";
                ...
                String query2="select AMOUNT, DATE from customer_pay where RETAILER=? and DATE between '"+ date1 +"' and '"+ date2 +"'";
