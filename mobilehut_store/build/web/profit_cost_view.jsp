                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li style="margin: 12px 20px">
                                    <div>
                                        <form action="datewise_profit_cost.jsp" method="POST" class="form-inline">
                                            ...
                                            <tbody id="myTable">
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        String query = "select COST_NAME, AMOUNT, DATE from profit_cost where YEAR(DATE) = YEAR(CURRENT_DATE()) AND MONTH(DATE) = MONTH(CURRENT_DATE()) order by DATE ";
