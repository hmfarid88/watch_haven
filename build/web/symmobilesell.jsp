                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <form id="saleform" method="POST" action="SellEntryServlet" class=" form-inline">
                                        ...
                                        <label>Products No</label><br>
                                        <input type="text"  class="form-control input-sm" name="imei" id="imei" value="" required="" autofocus="" >
                                        <input type="submit" id="submit"  value="OK" class="btn btn-primary btn-xs">
                                ...
                                <div class="col-sm-6">
                                    <form id="saleform" method="POST" action="SellEntryServlet">
                                       <input type="hidden" name="cid" value="${iid+1}">
                                        ...
                                        <select style=" max-width: 50%" class="form-control input-sm"  onchange="this.form.submit()"  name="imei" value=""  required="">
            ...
            rs01.next();
                                    ...
                                    <center>
                                        <form id="mrateform" method="POST" action="MrateupdateServlet">
                                            ...
                                            <input type="text" style="width:80px; text-align: center; color: black" name="price" id="price" value= "<%= rs.getFloat("PRICE") %>" readonly="">
                                        </form>
                                    ...
                                    <center>
                                        <form id="disform" method="POST" action="MdiscountServlet" class=" form-inline">
                                            ...
                                            <input type="number" style="width:100px; text-align: center; color: black; margin-top: 2px" name="discount" id="discount" value="<%= rs.getFloat("DISCOUNT") %>" required="">
                                            <input type="text" name="note" style="width:100px; text-align: center; color: black; margin-top: 2px" value="<%= rs.getString("DIS_NOTE") %>" onchange="myFunction()" placeholder="Note" >
                                ...
                                <fieldset class="scheduler-border">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control input-sm text-uppercase" name="address" value="${caddress}" required="">
                                        </div>
                                    </div> 
                                </fieldset>
