        ...
        <div id="main" class="container" >
            <nav style="margin: 0 auto" class="navbar navbar-inverse">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <ul  class="nav navbar-nav navbar-right">
                        ...
                        <li> <a href="symsellview.jsp"><span class="fa fa-backward"></span> Back</a></li>
            ...
            <%
                ...
                try {
                    ...
                    String query = "select CUSTOMER_ID, DATE from paymentinfo where INVOICE_NO=?";
                    ps=con.prepareStatement(query);
                    ps.setString(1, invono);
                    rs= ps.executeQuery();
                    while (rs.next()) {
                        request.setAttribute("saledate", rs.getString("DATE"));
                        request.setAttribute("cid", rs.getString("CUSTOMER_ID"));
                    }
            ...
            <div class="col-sm-8">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form method="POST" action="later_saleUpdate_process_date.jsp" >
                            <div class="row">
