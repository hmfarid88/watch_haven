                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li>
                                   ...
                                   <form class=" form-inline" method="POST" action="DemoPriceUpdate">
                                <select   name="imei"  class="form-control input-sm"  required="" >
                            ...
                            <%
                                ...
                                try {
                                    ...
                                    String query = "select MODEL, IMEI, PURCHASE_PRICE, SELL_PRICE from stock where MODEL  like '%"+ demo +"%' order by MODEL ";
                ...
                <center>
                    ...
                    <table  border="2" id="mobiletable" class=" table-striped table-responsive" width="95%" >
                        ...
                        <%
                            ...
                            try {
                                con = Ssymphonyy.getConnection();
                                String query = "select MODEL, COLOR, IMEI, PURCHASE_PRICE, SELL_PRICE, VENDOR, DATE from stock where MODEL  like '%"+ demo +"%' order by DATE DESC, MODEL ";
                                ps = con.prepareStatement(query);
                                rs = ps.executeQuery();
                                while (rs.next()) {
                        %>
