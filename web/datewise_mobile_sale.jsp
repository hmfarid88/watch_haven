                                            ...
                                            <tbody id="myTable">
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        String query = "select PRODUCT_ID, CUSTOMER_ID, INVOICE_NO,BRAND, MODEL, COLOR, PRICE, DISCOUNT, DIS_NOTE, VENDOR, SELL_DATE from mobilesell where SELL_DATE between '"+ date1 +"' and '"+ date2 +"' order by SELL_DATE ";
                                                        ps=con.prepareStatement(query);
                                                        rs = ps.executeQuery();
                                                        while (rs.next()) {
                                                            int cid=rs.getInt(2);
                                                   String query1="select C_NAME, PHONE_NUMBER, ADDEREE from customerinfo where CUSTOMER_ID="+cid;
