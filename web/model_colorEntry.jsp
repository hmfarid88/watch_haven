...
legend.scheduler-border {
  ...
  try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <fieldset class="scheduler-border">
                             <legend class="scheduler-border">Add Brand, Color & Vendor Name</legend>
                            <div class="col-sm-4">
                                <form method="POST" action="brand_entryProcess.jsp">
                                    <label>Brand Name :</label>
                                    <input type="text" value="" class="form-control" name="brand" id="color" required=""><br><br>
