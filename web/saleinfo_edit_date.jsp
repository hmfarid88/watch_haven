        ...
        <div id="main" class="container" >
            ...
            <%
                ...
                try {
                    ...
                    String query = "select CUSTOMER_ID, DATE from paymentinfo where CUSTOMER_ID=(select max(CUSTOMER_ID) from customerinfo)";
            ...
            <div class="col-sm-8">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form method="POST" action="saleUpdate_process_date.jsp" >
                            <div class="row">
