                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li id="drop">
                                ...
                                <div id="dropdown" class="dropdown-menu" >
                                    <a  href="symstockview.jsp">Product Stock</a>
                                    ...
                                    <a  href="#" data-toggle="modal" data-target="#prestock">Previous Stock</a>
                            ...
                            <li id="drop">
                                ...
                                <div  id="dropdown" class=" dropdown-menu">
                                    <a  data-toggle="collapse" data-target="#dvshow" href="#">Products</a>
                                    ...
                                    <a data-toggle="collapse" data-target="#nmdivshow" href="#">Previous Invoice</a>
...
<h1 style="font-family: Stylish;  font-size: 4vw; color: red; text-shadow: 2px 2px 3px white;" class="text-uppercase text-center"><b>${company}</b></h1>
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                            ...
                            <div class="col-sm-4 col-md-4">
                                <button class="btn btn-success btn-block"><h3><strong> Stock Info<br> ${stocktotal}|${stockqty}</strong></h3></button>
                            </div>
                            <div class="col-sm-4 col-md-4">
                                <button class="btn btn-success btn-block"><h3><strong> Sale Info<br> ${saletotal}|${tqty}</strong></h3></button>
                            </div>
                           <%                                
   ...
   try { if (con != null) con.close(); con=null; } catch (SQLException ex2) { }
                                ...
                                %>
                                <button class="btn btn-success btn-block"><h3><strong>Cash Balance <br> ${nbalance}</strong></h3></button> 

                            </div>

                        </div><br>
                        <fieldset class="scheduler-border">
                            <legend style=" color: #ffffff" class="scheduler-border">Input Area</legend>
                            <center>   <br><br>
                                <div class="row">
                                    <div class="col-sm-3"></div>
                                    <div class="col-sm-6">
                                        <a href="symstockentry.jsp"><button type="button" class="btn btn-success form-control ">Product-Entry</button></a><br><br>
                                        <!--<a href="symaccesor_entry.jsp"><button type="button" class="btn btn-success form-control ">Accessories-Entry</button></a><br><br>-->
                                        <a href="symmobilesell.jsp"><button type="button" class="btn btn-success form-control ">Product-Sale</button></a><br><br><br>
